  ...
  <section id="main" class="d-flex flex-column gap-3">
    <section id="form-create" class="rounded rounded-3 p-8 bg-white">
      <el-skeleton :loading="loading" :rows="6" animated>
        <template #default>
          <el-form
            :rules="assetStatusRules"
            :model="assetStatusDetails"
            ref="assetStatusFormRef"
            scroll-to-error
          >
                ...
                <div class="flex-grow-1 d-flex flex-column gap-7">
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="assetStatusId">
                        <el-input
                          size="default"
                          v-model="assetStatusDetails.assetStatusId"
                          placeholder="Input "
                          id="assetStatusDetails.assetStatusId"
                          name="assetStatusDetails.assetStatusId"
                          type="Input "
                          disabled
                        />
                      </el-form-item>
                  ...
                  <div class="row">
                    ...
                    >
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="assetStatus1">
                        <el-select
                          v-model="assetStatusDetails.assetStatus1"
                          id="assetStatusDetails.assetStatus1"
                          name="assetStatusDetails.assetStatus1"
                          class="w-100"
                          placeholder="Search"
                          clearable
                          filterable
                  ...
                  <div class="row">
                    ...
                    >
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="assetStatusDescription">
                        <el-input
                          size="default"
                          v-model="assetStatusDetails.assetStatusDescription"
                          placeholder="Input"
                          id="assetStatusDetails.assetStatusDescription"
                          name="assetStatusDetails.assetStatusDescription"
                          :rows="3"
                          type="textarea"
                          clearable
                        />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="modifiedBy">
                        <el-input
                          size="default"
                          v-model="assetStatusDetails.modifiedBy"
                          placeholder="Input "
                          id="assetStatusDetails.modifiedBy"
                          name="assetStatusDetails.modifiedBy"
                          type="Input "
                          disabled
                        />
                      </el-form-item>
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <div class="demo-date-picker">
                        <div class="block">
                          ...
                          <el-date-picker
                            v-model="assetStatusDetails.lastModifiedDate"
                            type="date"
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="associationStatus">
                        <el-radio-group
                          v-model="assetStatusDetails.associationStatus"
                        >
                          <el-radio :label="true"
              ...
              >
                ...
                >
                  <span class="indicator-label fs-6">
                    {{ assetStatusDetails.assetStatusId ? "Update" : "Save" }}
                  </span>
    ...
    <section id="asset-status-list" class="rounded rounded-3 p-8 bg-white">
      <el-skeleton :loading="loading" :rows="10" animated>
        <template #default>
          <div class="d-flex flex-column">
              ...
              <span class="my-1">
                ...
                <span>
                  ...
                  <span class="h6 fw-normal text-primary ms-1">
                    {{ assetStatusPageInfo.pageInfo?.recordsFiltered }}
                    of
                    {{ assetStatusPageInfo.pageInfo?.totalPages }} data</span
                  >
                </span>
              </span>
            </div>
            ...
            <Datatable
              :header="assetStatusHeader"
              :data="assetStatusList"
              :items-per-page="assetStatusPageInfo?.length"
              :items-per-page-dropdown-enabled="true"
              :loading="loadingFilter"
              :total-info-enabled="false"
              sortingEnabled
            >
              <template v-slot:assetStatusId="{ row: data }">
                <div
                  class="fs-5 text-primary cursor-pointer"
                  @click="onEdit(data)"
                >
                  {{ getValueFromList(data.assetStatusId, listOfSample) }}
                </div>
              </template>
              <template v-slot:assetStatus1="{ row: data }">
                <div class="fs-5">
                  {{ getValueFromList(data.assetStatus1, listOfSample) }}
                </div>
              </template>
              <template v-slot:assetStatusDescription="{ row: data }">
                <div class="fs-5">
                  {{
                    getValueFromList(data.assetStatusDescription, listOfSample)
                  }}
                </div>
              </template>
...
<script src="./AssetStatus.ts" lang="ts"></script>
