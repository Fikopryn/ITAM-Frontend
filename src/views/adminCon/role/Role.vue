<template>
  ...
  <section id="main" class="d-flex flex-column gap-3">
                ...
                <div class="flex-grow-1 d-flex flex-column gap-7">
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="roleId">
                        <el-input
                          size="default"
                          v-model="roleDetails.roleId"
                          placeholder=""
                          id="roleDetails.roleId"
                          name="roleDetails.roleId"
                          type=""
                          disabled
                        />
                      </el-form-item>
                  ...
                  <div class="row">
                    ...
                    >
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="roleName">
                        <el-select
                          v-model="roleDetails.roleName"
                          id="roleDetails.roleName"
                  ...
                  <div class="row">
                    ...
                    >
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="roleDescription">
                        <el-input
                          size="default"
                          v-model="roleDetails.roleDescription"
                          placeholder="Input"
                          id="roleDetails.roleDescription"
                          name="roleDetails.roleDescription"
                          :rows="3"
                          type="textarea"
                          clearable
                        />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="modifiedBy">
                        <el-input
                          size="default"
                          v-model="roleDetails.modifiedBy"
                          placeholder=""
                          id="roleDetails.modifiedBy"
                          name="roleDetails.modifiedBy"
                          type=""
                          disabled
                        />
                      </el-form-item>
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <div class="demo-date-picker">
                        <div class="block">
                          ...
                          <el-date-picker
                            v-model="roleDetails.lastModifiedDate"
                            type="date"
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 fs-5 fw-normal my-auto">
                      <el-form-item class="mb-n1" prop="associationStatus">
                        <el-radio-group v-model="roleDetails.associationStatus">
                          <el-radio :label="true"
              ...
              >
                ...
                >
                  <span class="indicator-label fs-6">
                    {{ roleDetails.roleName ? "Update" : "Save" }}
                  </span>
    ...
    <section id="role-list" class="rounded rounded-3 p-8 bg-white">
        ...
        <template #default>
          <div class="d-flex flex-column">
              ...
              <span class="my-1">
                ...
                <span>
                  ...
                  <span class="h6 fw-normal text-primary ms-1">
                    {{ rolePageInfo.pageInfo?.recordsFiltered }}
                    of
                    {{ rolePageInfo.pageInfo?.totalPages }} data</span
                  >
                </span>
              </span>
            </div>
            ...
            <Datatable
              :header="roleHeader"
              :data="roleList"
              :items-per-page="rolePageInfo?.length"
              :items-per-page-dropdown-enabled="true"
              :loading="loadingFilter"
              :total-info-enabled="false"
              sortingEnabled
            >
              <template v-slot:roleId="{ row: data }">
                <div
                  class="fs-5 text-primary cursor-pointer"
                  @click="onEdit(data)"
                >
                  {{ getValueFromList(data.roleId, listOfSample) }}
                </div>
              </template>
              <template v-slot:roleName="{ row: data }">
                <div class="fs-5">
                  {{ getValueFromList(data.roleName, listOfSample) }}
                </div>
              </template>
              <template v-slot:roleDescription="{ row: data }">
                <div class="fs-5">
                  {{ getValueFromList(data.roleDescription, listOfSample) }}
                </div>
              </template>
...
<script src="./Role.ts" lang="ts"></script>
