<template>
  <div class="dataTables_paginate paging_simple_numbers">
    <ul class="pagination">
      <li
        class="paginate_button page-item border rounded bg-white"
      ...
      >
        <a class="page-link" @click="onClickFirstPage">
          <span class="svg-icon">
            <inline-svg
              :src="getMediaPath('icons/duotune/arrows/arr079.svg')"
            />
          </span>
        </a>
      </li>
      ...
      >
        <a class="page-link" @click="onClickPreviousPage">
          <span class="svg-icon">
            <inline-svg
              :src="getMediaPath('icons/duotune/arrows/arr074.svg')"
            />
          </span>
        </a>
      </li>
      ...
      <li
        ...
        class="paginate_button page-item border rounded"
        style="background-color: white !important; border-color: #d1d5ec"
        :class="{
      ...
      >
        <a class="paginate_button page-link" @click="onClickNextPage">
          <span class="svg-icon">
            <inline-svg
              :src="getMediaPath('icons/duotune/arrows/arr071.svg')"
            />
          </span>
        </a>
      </li>
      ...
      >
        <a class="paginate_button page-link" @click="onClickLastPage">
          <span class="svg-icon">
            <inline-svg
              :src="getMediaPath('icons/duotune/arrows/arr080.svg')"
            />
          </span>
        </a>
      </li>
