  ...
  <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
      ...
      <div
        ...
        class="menu menu-column menu-sub-indention"
        data-kt-menu="true"
      >
        <template v-for="(item, i) in MainMenuConfig" :key="i">
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <template v-if="menuItem.heading && menuItem.userHasAccess">
              <div class="menu-item">
                <router-link
                  v-if="menuItem.route"
                  class="menu-link"
            ...
            >
              ...
              >
                <template v-for="(item2, k) in menuItem.sub" :key="k">
                  <div
                    v-if="item2.userHasAccess && item2.heading"
                    class="menu-item"
                  >
                    <router-link
                      v-if="item2.route"
